...
export class DiagnosticcenterslotsComponent implements OnInit {
  ...
  public adddetails() {
    ...
    // }
      ...
      if (this.appointmenttype == 1) {
        var mrngslots = this.mrngfromlist.findIndex((x: { id: number; }) => x.id == this.mrngtoid);
        this.mrngfromlist = this.mrngfromlist.slice(mrngslots + 1, this.mrngfromlist.length);
      }
      else if (this.appointmenttype == 2) {
        var diaslots = this.diagnsticfromlist.findIndex((x: { id: number; }) => x.id == this.diatoid);
  ...
  public getmrngfrom(even: any) {
    ...
    var qwerty = this.mrngfromlist.filter((x: { id: number; }) => x.id == this.mrngfromid);
  ...
  public getmrngto(even: any) {
    ...
    var qwerty = this.mrngtolist.filter((x: { id: number; }) => x.id == this.mrngtoid);
  ...
  public GetDiagnosticFromSlots(even: any) {
    ...
    var qwerty = this.diagnsticfromlist.filter((x: { id: number; }) => x.id == this.diafromid);
  ...
  public getDiagnosticToSlots(even: any) {
    ...
    var qwerty = this.diatolist.filter((x: { id: number; }) => x.id == this.diatoid);
    ...
    for (let i = 0; i < this.qwerty.length; i++) {
      ...
      if (Sno == this.qwerty[i].Sno) {
        ...
        if (this.qwerty[i].mrngAppointmenttype == 1) {
          var mrngslots = this.slotslist.findIndex((x: { id: number; }) => x.id == this.qwerty[i].MrngfromID);
