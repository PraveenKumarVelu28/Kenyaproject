...
export class MediTestService {
  ...
  public host = 'https://103.12.1.76/MediTestApi';
  ...
  public Getloginlabel(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetAdmin_RegisterLogins_Label?LanguageID=' + lid
    );
  }
  public GetAdmin_LoginPage_Labels(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetAdmin_LoginPage_Labels?LanguageID=' + lid
    );
  }
  public GetAdmin_Sponsored_Label(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetAdmin_Sponsored_Label?LanguageID=' + lid
    );
  }
  public GetDiagnosticForAdminByLanguageID(did: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDiagnosticForAdminByLanguageID?LanguageID=' + did
    );
  }
  public GetDiagnosticDetailsForWeb(sdate: any, edate: any, lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticDetailsForWeb?SDate=' +
        sdate +
        '&EDate=' +
        edate +
        '&LanguageID=' +
  ...
  public GetAdmin_DiagnosticRegistration_LabelBYLanguageID(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAdmin_DiagnosticRegistration_LabelBYLanguageID?LanguageID=' +
        lid
    );
  }
  ...
  public GetAreaMasterByCityIDAndLanguageID(did: any, lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAreaMasterByCityIDAndLanguageID?CityID=' +
        did +
        '&LanguageID=' +
        lid
    );
  ...
  public GetInsuranceMasterByLanguageID(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetInsuranceMasterByLanguageID?LanguageID=' + lid
    );
  }
  ...
  public InsertDiagnosticCentersSubscriptions_Revenue(data: any) {
    this.url =
      this.host + '/Master/InsertDiagnosticCentersSubscriptions_Revenue';
    return this.http.post(this.url, data);
  }
  ...
  public GetCityMasterBYIDandLanguageID(did: any, lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetCityMasterBYIDandLanguageID?CountryID=' +
        did +
        '&LanguageID=' +
        lid
    );
  ...
  public GetAdmin_Masters_labels(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetAdmin_Masters_labels?LanguageID=' + lid
    );
  }

  public GetAreaMasterByLangID(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetAreaMasterByLangID?LanguageID=' + lid
    );
  }

  public GetCityMasterByLangID(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetCityMasterByLangID?LanguageID=' + lid
    );
  }
  ...
  public DeleteDiagnosticCenter(id: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteDiagnosticCenter?ID=' + id
    );
  }
  public GetDiagnosticDetailsForAdminByLanguageID(did: any, lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticDetailsForAdminByLanguageID?DiagnosticID=' +
        did +
        '&LanguageID=' +
        lid
    );
  ...
  public GetDiagnosticCenterPhotosByID(diaid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDiagnosticCenterPhotosByID?ID=' + diaid
    );
  }
  ...
  public GetAdmin_DiagnosticLoginOrdersAndOrderReport_Label(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAdmin_DiagnosticLoginOrdersAndOrderReport_Label?LanguageID=' +
        lid
    );
  }

  public GetDiagnosticAppointmentsByDiagnosticID(
    id: any,
    sdate: any,
    edate: any,
    lid: any
    ...
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticAppointmentsByDiagnosticID?DiagnosticCenterID=' +
        id +
        '&SDate=' +
        sdate +
        '&EDate=' +
  ...
  public GetDiagnosticAppointmentsByDiagnosticIDMediTest(
    id: any,
    sdate: any,
    edate: any,
    lid: any
    ...
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticAppointmentsByDiagnosticIDMediTest?DiagnosticCenterID=' +
        id +
        '&SDate=' +
        sdate +
        '&EDate=' +
  ...
  public GetAssigned_Phlebotomist_Details(sdate: any, StaffID: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAssigned_Phlebotomist_Details?SDate=' +
        sdate +
        '&StaffID=' +
        StaffID
    );
  ...
  public GetAdmin_DoctorMyAppointments_Label(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAdmin_DoctorMyAppointments_Label?LanguageID=' +
        lid
    );
  }
  ...
  public GetDiagnosticCentersSubscriptions_Revenue(diagnosticid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticCentersSubscriptions_Revenue?DiagnosticID=' +
        diagnosticid
    );
  }
  public UpdateDiagnosticCentersSubscriptions_Revenue(data: any) {
    this.url =
      this.host + '/Master/UpdateDiagnosticCentersSubscriptions_Revenue';
    return this.http.post(this.url, data);
  }
  ...
  public DeleteAreaMaster(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteAreaMaster?ID=' + lid
    );
  }

  public DeleteCountryMaster(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteCountryMaster?ID=' + lid
    );
  }

  public DeleteCityMaster(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteCityMaster?ID=' + lid
    );
  }
  ...
  public GetAdmin_Doctorregistration_LabelsByLanguageID(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAdmin_Doctorregistration_LabelsByLanguageID?LanguageID=' +
        lid
    );
  }
  ...
  public GetMyTeam(did: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetMyTeam?DiagnosticID=' + did
    );
  }
  ...
  public GetUserRegistration() {
    return this.http.get<any[]>(this.host + '/Master/GetUserRegistration');
  }
  ...
  public GetAdmin_WorkingDetails_label(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetAdmin_WorkingDetails_label?LanguageID=' + lid
    );
  }
  public GetAdmin_DoctorLoginFeedbackWorkingDetails_Label(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAdmin_DoctorLoginFeedbackWorkingDetails_Label?LanguageID=' +
        lid
    );
  }
  public GetDiagnosticSlotsWeb(did: any, date: any, timeid: any, dayid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticSlotsWeb?DiagnosticCenterID=' +
        did +
        '&Date=' +
        date +
        '&TimeID=' +
  ...
  public GetDiagnosticSlots(did: any, lid: any, typeid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticSlots?DiagnosticCenterID=' +
        did +
        '&LanguageID=' +
        lid +
        '&TypeIDs=' +
  ...
  public DeleteDiagnosticRelatedSlotsStartTimeEndTime(
    diaid: any,
    dayid: any,
    timeid: any
  ) {
    return this.http.get<any[]>(
      this.host +
        '/Master/DeleteDiagnosticRelatedSlotsStartTimeEndTime?DiagnosticCenterID=' +
        diaid +
        '&DayID=' +
        dayid +
        '&TimeID=' +
  ...
  public DeleteDiagnosticRelatedSlots(id: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteDiagnosticRelatedSlots?ID=' + id
    );
  }
  ...
  public GetDaysMasterByLanguageID(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDaysMasterByLanguageID?LanguageID=' + lid
    );
  }
  ...
  public GetDiagnosticCenterListByLanguageID(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticCenterListByLanguageID?LanguageID=' +
        lid
    );
  }
  public GetDiagnosticSlotMasterByTimeID(timeid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDiagnosticSlotMasterByTimeID?TimeID=' + timeid
    );
  }
  ...
  public GetAdmin_MapServiceDiagnostic_Label(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetAdmin_MapServiceDiagnostic_Label?LanguageID=' +
        lid
    );
  }
  ...
  public GetDiagnosticCenterPackages(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDiagnosticCenterPackages?LanguageID=' + lid
    );
  }
  public DeleteDiagnosticCenterPackages(id: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteDiagnosticCenterPackages?ID=' + id
    );
  }
  public GetDiagnosticTestMasterByLanguageID(lid: any) {
    return this.http.get<any[]>(
      this.host +
        '/Master/GetDiagnosticTestMasterByLanguageID?LanguageID=' +
        lid
    );
  }
  public GetDiagnosticCenterDetailsByID(id: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDiagnosticCenterDetailsByID?ID=' + id
    );
  }
  ...
  public GetDiagnosticCenterTestsForDash(lid: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDiagnosticCenterTestsForDash?LanguageID=' + lid
    );
  }

  public DeleteDiagnosticCenterTestsForDash(id: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteDiagnosticCenterTestsForDash?ID=' + id
    );
  }
  ...
  public GetPatientRegistrationWeb() {
    debugger;
    return this.http.get<any[]>(
      this.host + '/Master/GetPatientRegistrationWeb'
    );
  }
  ...
  public AcceptOrderandcllectcash(data: any) {
    this.url = this.host + '/Master/AcceptOrderandcllectcash';
    return this.http.post(this.url, data);
  }
  public MediSMSNEW(data: any) {
    this.url = this.host + '/Diagnostic/MediSMSNEW';
    return this.http.post(this.url, data);
  }
  ...
  public testoffersEnableDisable(data: any) {
    debugger;
    this.url = this.host + '/Master/testoffersEnableDisable';
    return this.http.post(this.url, data);
  }
  ...
  public UpdateTestOffers(data: any) {
    this.url = this.host + '/Master/UpdateTestOffers';
    return this.http.post(this.url, data);
  }
  ...
  public GetMediTestOrderDetailsNewWeb() {
    return this.http.get<any[]>(
      this.host + '/Master/GetMediTestOrderDetailsNewWeb'
    );
  }
  ...
  public GetDiagnosticAppointmentPhotos() {
    return this.http.get<any[]>(
      this.host + '/Master/GetDiagnosticAppointmentPhotos'
    );
  }

  public GetCountryMasterByLanguageID(lid: any) {
    return this.http.get<any[]>(
      ' https://qa.his.clinivantage.dev/adt/getActiveCountryList/35'
    );
  }
  ...
  public GetStatefromMeditest() {
    ...
    this.url =
      'https://qa.his.clinivantage.dev/adt/getActiveStateListByCountryId';
  ...
  public GetCityfromMeditest() {
    ...
    this.url =
      '  https://qa.his.clinivantage.dev/adt/getActiveDistrictListByStateId';
    return this.http.post(this.url, entity);
  }
  ...
  public GetPackagesfromMeditest() {
    ...
    this.url =
      'https://qa.his.clinivantage.dev/api/packages/bill/package/search';
    return this.http.post(this.url, entity);
  }
  public GetLabReportfromHIS(labSampleDtlsIds: any) {
    ...
    this.url =
      'https://intdev.his.clinivantage.dev/LIS/transaction/labReportPDF/getBinaryStringOfLABReport';
    return this.http.post(this.url, entity);
  }
  ...
  public GetServices(data: any): Observable<any[]> {
    const services = [
      { testName: '25 HYDROXY (OH) VITAMIN D', testPrice: 1200 },
      { testName: 'ADENOSINE DEAMINASE (ADA)', testPrice: 800 },
      { testName: 'ADRENOCORTICOTROPIC HORMONE (ACTH)', testPrice: 1500 },
      { testName: 'AEROBIC, BLOOD CULTURE AND SENSITIVITY', testPrice: 1000 },
      {
        testName: 'ALANINE AMINOTRANSFERASE (ALT/ SGPT), SERUM',
        testPrice: 500,
      },
      { testName: 'AFB SMEAR BY ZN STAIN', testPrice: 600 },
      { testName: 'ALBUMIN, SERUM', testPrice: 450 },
      { testName: 'ALCOHOL (ETHANOL), SERUM', testPrice: 900 },
      { testName: 'ALKALINE PHOSPHATASE, SERUM', testPrice: 700 },
      { testName: 'ANCA-C', testPrice: 1200 },
      { testName: 'ANCA-P', testPrice: 1200 },
      { testName: 'ANTI CCP', testPrice: 1300 },
      { testName: 'ANTI DS DNA', testPrice: 1400 },
      { testName: 'ANTI PHOSPHOLIPID IgG', testPrice: 1000 },
      { testName: 'ANTI PHOSPHOLIPID IgM', testPrice: 1000 },
    ];

    return of(services); // Wrap in `of()` to return as an observable
  }
